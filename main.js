    ...
    portfolioData.forEach(item => {
        ...
        portfolioItem.innerHTML = `
                    <div class="h-48 bg-gradient-to-r ${item.gradient} rounded-lg mb-4 flex items-center justify-center">
                        <img src="/screenshots/${item.imgFile}" class="size-full rounded-lg" alt="">
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/sites/${item.link}" class="text-sm glass-card px-3 py-1 rounded-full hover:bg-purple-500/20 transition-colors">
                            View
                        </a>
                    </div>
                `;
